"""
Base settings for LMS Backend project.
...
# Security
# SECURITY FIX: Ensure SECRET_KEY is properly configured
...
# Ensure leading slashes so generated URLs are absolute (e.g. /static/)
STATIC_URL = '/static/'
